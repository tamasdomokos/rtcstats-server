...
class WsHandler {
     ...
     */
    processData(id, dumpPath, connectionInfo, tenantInfo) {
    ...
    _handle(client, upgradeReq) {
        ...
        const demuxSink = this._createDemuxSink(statsSessionId, dumpPath, connectionInfo);
     ...
     *
     */
    _createDemuxSink(statsSessionId, dumpPath, connectionInfo) {
        logger.info(`test CreateDemuxSink: statsSessionId: ${statsSessionId}`);
    ...
    _getDumpPath(statsSessionId) {
        logger.info(`test dumpa folder: ${this.dumpFolder} statsSessionId: ${statsSessionId}`);
